...
class C_adistyaAuth extends CI_Controller
{
	...
	public function index()
	{
		...
		if ($this->form_validation->run() == false) {
			...
			$this->load->view('v_adistyaLogin', $data);
		} else {
	...
	public function login2()
	{
		...
		$this->load->view('v_adistyaLogin2');
	}
		...
		if ($user_pengguna) {
			...
			if (password_verify($password, $user_pengguna['password'])) {
				...
				if ($user_pengguna['level'] == 1) {
					redirect('C_adistyaAdmin'); //admin
				} else if ($user_pengguna['level'] == 2) {
					redirect('C_adistyaAdmin'); //resepsionis
				} else if ($user_pengguna['level'] == 3){
					redirect('C_adistyaUser'); //user
				}
	...
	public function register()
	{
		...
		if ($this->form_validation->run() == false) {
			...
			$this->load->view('v_adistyaRegister', $data);
		} else {
	...
	public function register2()
	{
		...
		if ($this->form_validation->run() == false) {
			...
			$data['title'] = 'Register Hotel';
			$this->load->view('v_adistyaRegister2', $data);
		} else {
