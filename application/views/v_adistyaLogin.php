                ...
                <?= $this->session->flashdata('message'); ?>
                    ...
                    <form method="post" action="<?= base_url('C_adistyaAuth') ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 d-lg-block card o-hidden border-0"><img src="<?= base_url('assets/') ?>as/images/deluxe.jpeg" alt="#"/>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user">
                                        ...
                                        <button type="submit"
                                            class="btn btn-warning btn-user btn-login col-md-12 ">Login</button>
                                        <hr>
                                    <div class="text-center">
                                        <a class="small" href="<?= base_url('C_adistyaAuth/register') ?>">Create an Account!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
