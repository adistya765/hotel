                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <br>
                                    <h3 class="text-center font-weight-light my-10">Create Account</h3>
                                </div>
                                <div class="card-body">

                                    <form method="post" action="<?= base_url('C_adistyaAuth/register2'); ?>">
                                        ...
                                        <div class="mt-4 mb-0">
                                            <button type="submit" class="btn btn-warning  btn-block mb-1">Register
                                                Account</button>
                                                <br>
                                        
                                                <br>
                                            <div class="small"><a href="<?= base_url('C_adistyaAuth/register2') ?>"></div>
